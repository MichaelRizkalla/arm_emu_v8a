#ifndef SHARED_OPERATIONS_FUNCTIONS_INTEGER_HPP
#define SHARED_OPERATIONS_FUNCTIONS_INTEGER_HPP
...
namespace arm_emu {
    ...
    [[nodiscard]] inline auto AddWithCarry(std::bitset< N > x, std::bitset< N > y, bool carry_in) {
...
#endif // SHARED_OPERATIONS_FUNCTIONS_INTEGER_HPP
