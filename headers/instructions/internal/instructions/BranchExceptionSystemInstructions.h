...
namespace arm_emu {
    ...
    */
    struct Branch_Exception_SystemGroup : public AbstractInstruction< std::uint32_t, Branch_Exception_SystemGroup > {
        [[nodiscard]] auto getInstructionClass() const noexcept {
            return Branch_Exception_SystemA64::getInstructionClass(mInstruction);
        }
    ...
    struct Branch_Exception_SystemInstruction< Branch_Exception_SystemA64::InstructionGroupEnum::CONDITIONAL_BRANCHING > final : public Branch_Exception_SystemGroup {
        ...
        [[nodiscard]] inline auto get_imm19() const noexcept {
    ...
    struct Branch_Exception_SystemInstruction< Branch_Exception_SystemA64::InstructionGroupEnum::SYSTEM_INSTRUCTIONS > final : public Branch_Exception_SystemGroup {
        ...
        [[nodiscard]] auto get_op2() const noexcept {
            return static_cast< std::uint8_t >(static_cast< std::uint32_t >(0b111) & (mInstruction >> 5));
        }
        [[nodiscard]] auto get_CRm() const noexcept {
            return static_cast< std::uint8_t >(static_cast< std::uint32_t >(0b1111) & (mInstruction >> 8));
        }
        [[nodiscard]] auto get_CRn() const noexcept {
            return static_cast< std::uint8_t >(static_cast< std::uint32_t >(0b1111) & (mInstruction >> 12));
        }
        [[nodiscard]] auto get_op1() const noexcept {
            return static_cast< std::uint8_t >(static_cast< std::uint32_t >(0b111) & (mInstruction >> 16));
        }
        [[nodiscard]] auto get_L() const noexcept {
            return readBit(21);
        }
    ...
    struct Branch_Exception_SystemInstruction< Branch_Exception_SystemA64::InstructionGroupEnum::SYSTEM_REGISTER_MOVE > final : public Branch_Exception_SystemGroup {
        ...
        [[nodiscard]] auto get_o0() const noexcept {
            return readBit(19);
        }
        [[nodiscard]] auto get_L() const noexcept {
            return readBit(21);
    ...
    template <>
    struct Branch_Exception_SystemInstruction< Branch_Exception_SystemA64::InstructionGroupEnum::UNCONDITIONAL_BRANCH_REGISTER > final
        ...
        [[nodiscard]] inline auto get_M() const noexcept {
            return readBit(10);
        }

        [[nodiscard]] inline auto get_A() const noexcept {
            return readBit(11);
        }
    ...
    struct Branch_Exception_SystemInstruction< Branch_Exception_SystemA64::InstructionGroupEnum::UNCONDITIONAL_BRANCH_IMMEDIATE > final
        ...
        [[nodiscard]] inline auto get_imm26() const noexcept {
            return static_cast< std::uint32_t >(static_cast< std::uint32_t >(0x3FFFFFF) & (mInstruction >> 0));
        }
    ...
    template <>
    struct Branch_Exception_SystemInstruction< Branch_Exception_SystemA64::InstructionGroupEnum::COMPARE_AND_BRANCH_IMMEDIATE > final
        : public Branch_Exception_SystemGroup {
        [[nodiscard]] auto getInstructionType() const noexcept {
        ...
        [[nodiscard]] inline auto get_Rt() const noexcept {
            return static_cast< std::uint8_t >(static_cast< std::uint32_t >(0b11111) & (mInstruction >> 0));
        }

        [[nodiscard]] inline auto get_imm19() const noexcept {
            return static_cast< std::uint32_t >(static_cast< std::uint32_t >(0x3FFFF) & (mInstruction >> 5));
        }
