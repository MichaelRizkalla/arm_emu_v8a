...
static constexpr Table< DataProcessingImmediateGroupA64, enum_size_v< DataProcessingImmediateGroupA64 > > DataProcessingImmediateGroupA64Table { { {
    ...
    { 0b0001'1111'1000'0000'0000'0000'0000'0000, 0b0001'0001'1000'0000'0000'0000'0000'0000,
      DataProcessingImmediateGroupA64::ADD_SUBTRACT_IMMEDIATE_TAG },
...
private:
  static inline constexpr Table< PCRelativeAddressing, enum_size_v< PCRelativeAddressing > > PCRelativeAddressingTable { { {
  ...
  static inline constexpr Table< AddSubtractImmediate, enum_size_v< AddSubtractImmediate > > AddSubtractImmediateTable { { {
  ...
  static inline constexpr Table< AddSubtractImmediateTag, enum_size_v< AddSubtractImmediateTag > > AddSubtractImmediateTagTable { { {
  ...
  static inline constexpr Table< LogicalImmediate, enum_size_v< LogicalImmediate > > LogicalImmediateTable { { {
  ...
  static inline constexpr Table< MoveWideImmediate, enum_size_v< MoveWideImmediate > > MoveWideImmediateTable { { {
  ...
  static inline constexpr Table< Bitfield, enum_size_v< Bitfield > > BitfieldTable { { {
  ...
  static inline constexpr Table< Extract, enum_size_v< Extract > > ExtractTable { { {
