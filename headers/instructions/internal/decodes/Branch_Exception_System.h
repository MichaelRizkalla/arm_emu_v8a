...
namespace arm_emu {
    ...
    static Table< Branch_Exception_SystemGroupA64, enum_size_v< Branch_Exception_SystemGroupA64 > > Branch_Exception_SystemGroupA64Table { { {
    ...
    class Branch_Exception_SystemA64 {
      ...
      private:
        static inline Table< ConditionalBranching, enum_size_v< ConditionalBranching > >                 ConditionalBranchingTable { { {
            { 0b1111'1111'0000'0000'0000'0000'0001'0000, 0b0101'0100'0000'0000'0000'0000'0000'0000, ConditionalBranching::BCond },
        } } };
        static inline Table< ExceptionGeneration, enum_size_v< ExceptionGeneration > >                   ExceptionGenerationTable { { {
        ...
        static inline Table< Hints, enum_size_v< Hints > >                                               HintsTable { { {
        ...
        static inline Table< Barriers, enum_size_v< Barriers > + 14 >                                    BarriersTable { { {
        ...
        static inline Table< PState, enum_size_v< PState > >                                             PStateTable { { {
        ...
        static inline Table< SystemInstruction, enum_size_v< SystemInstruction > >                       SystemInstructionTable { { {
        ...
        static inline Table< SystemRegisterMove, enum_size_v< SystemRegisterMove > >                     SystemRegisterMoveTable { { {
        ...
        static inline Table< UnconditionalBranchRegister, enum_size_v< UnconditionalBranchRegister > >   UnconditionalBranchRegisterTable { { {
        ...
        static inline Table< UnconditionalBranchImmediate, enum_size_v< UnconditionalBranchImmediate > > UnconditionalBranchImmediateTable { { {
        ...
        static inline Table< CompareAndBranchImmediate, enum_size_v< CompareAndBranchImmediate > >       CompareAndBranchImmediateTable { { {
        ...
        static inline Table< TestAndBranchImmediate, enum_size_v< TestAndBranchImmediate > >             TestAndBranchImmediateTable { { {
