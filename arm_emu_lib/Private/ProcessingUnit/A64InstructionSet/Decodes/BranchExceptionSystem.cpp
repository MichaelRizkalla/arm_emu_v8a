...
template <>
static std::string_view Enum::ToChar(A64BranchExceptionSystemGroup elem) {
    return A64BranchExceptionSystemGroupStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, A64BranchExceptionSystemGroup elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::ConditionalBranching elem) {
    return A64ConditionalBranchingStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::ConditionalBranching elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::ExceptionGeneration elem) {
    return A64ExceptionGenerationStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::ExceptionGeneration elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::Hints elem) {
    return A64HintsStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::Hints elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::Barriers elem) {
    return A64BarriersStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::Barriers elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::PState elem) {
    return A64PStateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::PState elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::SystemInstruction elem) {
    return A64SystemInstructionStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::SystemInstruction elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::SystemRegisterMove elem) {
    return A64SystemRegisterMoveStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::SystemRegisterMove elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::UnconditionalBranchRegister elem) {
    return A64UnconditionalBranchRegisterStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::UnconditionalBranchRegister elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::UnconditionalBranchImmediate elem) {
    return A64UnconditionalBranchImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::UnconditionalBranchImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::CompareAndBranchImmediate elem) {
    return A64CompareAndBranchImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::CompareAndBranchImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(BranchExceptionSystemGroup::TestAndBranchImmediate elem) {
    return A64TestAndBranchImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, BranchExceptionSystemGroup::TestAndBranchImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}
