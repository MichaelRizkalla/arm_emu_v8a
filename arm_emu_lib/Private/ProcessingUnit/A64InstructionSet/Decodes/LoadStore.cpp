...
template <>
static std::string_view Enum::ToChar(A64LoadStoreGroup elem) {
    return A64LoadStoreGroupStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, A64LoadStoreGroup elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::AdvancedSIMDLoadStoreMultipleStructures elem) {
    return AdvancedSIMDLoadStoreMultipleStructuresStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::AdvancedSIMDLoadStoreMultipleStructures elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::AdvancedSIMDLoadStoreMultipleStructuresPostIndexed elem) {
    return AdvancedSIMDLoadStoreMultipleStructuresPostIndexedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::AdvancedSIMDLoadStoreMultipleStructuresPostIndexed elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::AdvancedSIMDLoadStoreSingleStructure elem) {
    return AdvancedSIMDLoadStoreSingleStructureStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::AdvancedSIMDLoadStoreSingleStructure elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::AdvancedSIMDLoadStoreSingleStructurePostIndexed elem) {
    return AdvancedSIMDLoadStoreSingleStructurePostIndexedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::AdvancedSIMDLoadStoreSingleStructurePostIndexed elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreMemoryTag elem) {
    return LoadStoreMemoryTagStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreMemoryTag elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreExclusive elem) {
    return LoadStoreExclusiveStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreExclusive elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LdaprStlrUnscaledImmediate elem) {
    return LdaprStlrUnscaledImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LdaprStlrUnscaledImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadRegisterLiteral elem) {
    return LoadRegisterLiteralStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadRegisterLiteral elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreNoAllocatePairOffset elem) {
    return LoadStoreNoAllocatePairOffsetStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreNoAllocatePairOffset elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterPairPostIndexed elem) {
    return LoadStoreRegisterPairPostIndexedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterPairPostIndexed elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterPairOffset elem) {
    return LoadStoreRegisterPairOffsetStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterPairOffset elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterPairPreIndexed elem) {
    return LoadStoreRegisterPairPreIndexedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterPairPreIndexed elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterUnscaledImmediate elem) {
    return LoadStoreRegisterUnscaledImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterUnscaledImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterImmediatePostIndexed elem) {
    return LoadStoreRegisterImmediatePostIndexedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterImmediatePostIndexed elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterUnprivileged elem) {
    return LoadStoreRegisterUnprivilegedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterUnprivileged elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterImmediatePreIndexed elem) {
    return LoadStoreRegisterImmediatePreIndexedStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterImmediatePreIndexed elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::AtomicMemoryOperation elem) {
    return AtomicMemoryOperationStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::AtomicMemoryOperation elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterRegisterOffset elem) {
    return LoadStoreRegisterRegisterOffsetStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterRegisterOffset elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterPAC elem) {
    return LoadStoreRegisterPACStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterPAC elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(LoadStoreGroup::LoadStoreRegisterUnsignedImmediate elem) {
    return LoadStoreRegisterUnsignedImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, LoadStoreGroup::LoadStoreRegisterUnsignedImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}
