...
template <>
static std::string_view Enum::ToChar(A64DataProcessingImmediateGroup elem) {
    return A64DataProcessingImmediateGroupStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, A64DataProcessingImmediateGroup elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::PCRelativeAddressing elem) {
    return PCRelativeAddressingStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::PCRelativeAddressing elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::AddSubtractImmediate elem) {
    return AddSubtractImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::AddSubtractImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::AddSubtractImmediateTag elem) {
    return AddSubtractImmediateTagStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::AddSubtractImmediateTag elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::LogicalImmediate elem) {
    return LogicalImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::LogicalImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::MoveWideImmediate elem) {
    return MoveWideImmediateStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::MoveWideImmediate elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::Bitfield elem) {
    return BitfieldStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::Bitfield elem) {
    os << Enum::ToChar(elem);
    return os;
}

template <>
static std::string_view Enum::ToChar(DataProcessingImmediateGroup::Extract elem) {
    return ExtractStringMap.At(elem);
}

template <>
std::ostream& operator<<(std::ostream& os, DataProcessingImmediateGroup::Extract elem) {
    os << Enum::ToChar(elem);
    return os;
}
